...
- Test (alle): `dotnet test backend/Aarshjul.slnx` — 151 tester (synlighet, datoberegning, innlegging, claims, HTTP-integrasjon, godkjenningskø, brukerforslag, Word-eksport, generering/valgår/anker-kjeder, demo-seed, datouttrekk/opplasting).
